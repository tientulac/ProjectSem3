...
namespace WebApplication1.DAL
{
    public class EventDAL
    {
        ...
        public ISingleResult<sp_Event_InsertResult> Insert(RequestEvent req)
        {
            ...
            try
            {
                sp_result = db.sp_Event_Insert(req.EventName,req.FromDate,req.ToDate,req.Content,req.Slot,req.DesiredAmount,req.DonateAmount,req.TypeId,req.LocalId,req.Status);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public ISingleResult<sp_Event_UpdateResult> Update(RequestEvent req)
        {
            ...
            try
            {
                sp_result = db.sp_Event_Update(req.EventName, req.FromDate, req.ToDate, req.Content, req.Slot, req.DesiredAmount, req.DonateAmount, req.TypeId, req.LocalId, req.Status,req.EventId);
            }
            catch (Exception ex)
            {
                throw ex;
